...
$scope.woo = function(){
    ...
    heroName =  $("#littleTime").val();
			...
			$('.image').html('');
			$('.events').html('');
			$.getJSON("http://gateway.marvel.com:80/v1/public/characters?name=" + heroName + "&limit=100&apikey= Your API KEY").then(function (json) {
	...
	two: function(callback){
			...
			$.getJSON("http://gateway.marvel.com:80/v1/public/characters?name=" + heroName2 + "&limit=100&apikey= Your API KEY").then( function (json) {
			...
			if(results1 == ''){
				...
				for (var j = 0; j<results1.length; j ++){
						...
						$('#'+j).click(function(){
							...
							$('.loading1').show();
							$('.loading').show();
							$.getJSON('http://gateway.marvel.com:80/v1/public/events?name=' + tryIt + '&apikey= Your API KEY', function (json){
							...
							$.getJSON('http://gateway.marvel.com:80/v1/public/events/'+wooStuff+'/characters?limit=100&apikey= Your API KEY', function (json){
							...
							$.getJSON('http://gateway.marvel.com:80/v1/public/events/'+wooStuff+'/series?apikey= Your API KEY', function (json){
